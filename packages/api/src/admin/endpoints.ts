...
export const ADMIN_EP = {
  ...
  // Banners — backend mounts the admin sub-router at /api/v1/admin/banners
  // with launch/pause verbs (banners.routes.ts:65-75). The old /banners/admin
  // + activate/deactivate paths 404'd every op. (BUGS.md M8.)
  BANNERS: `${ADMIN}/banners`,
  BANNER: (id: string) => `${ADMIN}/banners/${id}`,
  BANNER_ACTIVATE: (id: string) => `${ADMIN}/banners/${id}/launch`,
  BANNER_DEACTIVATE: (id: string) => `${ADMIN}/banners/${id}/pause`,
