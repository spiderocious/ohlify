...
export const ADMIN_NAV_ITEMS: readonly AdminNavItem[] = [
  ...
  { label: 'Bookings', Icon: IconCalendar, to: ADMIN_ROUTES.BOOKINGS.absPath, roles: STAFF },
  {
    label: 'Withdrawals',
    Icon: IconCreditCard,
    to: ADMIN_ROUTES.WITHDRAWALS.absPath,
    roles: FINANCE,
  },
  { label: 'Refunds', Icon: IconCreditCard, to: ADMIN_ROUTES.REFUNDS.absPath, roles: FINANCE },
  {
    label: 'Transactions',
    Icon: IconCreditCard,
    to: ADMIN_ROUTES.TRANSACTIONS.absPath,
    roles: FINANCE,
  },
  ...
  { label: 'Config', Icon: IconSettings, to: ADMIN_ROUTES.CONFIG.absPath, roles: ADMIN_ONLY },
  {
    label: 'App releases',
    Icon: IconSmartphone,
    to: ADMIN_ROUTES.APP_RELEASES.absPath,
    roles: ADMIN_ONLY,
  },
  { label: 'Campaigns', Icon: IconSend, to: ADMIN_ROUTES.CAMPAIGNS.absPath, roles: ADMIN_ONLY },
