export const MESSAGE_KEYS = {
  ...
  ROLE_ALREADY_SET: 'onboarding.role.already_set',
  ...
  // Minutes (calls revamp)
  MINUTES_BALANCES_FETCHED: 'minutes.balances.fetched',
  MINUTES_BALANCE_FETCHED: 'minutes.balance.fetched',
  MINUTES_PURCHASED: 'minutes.purchased',
  MINUTES_INSUFFICIENT_WALLET: 'minutes.insufficient_wallet',
  MINUTES_PRO_NOT_FOUND: 'minutes.professional_not_found',
  MINUTES_RATE_NOT_FOUND: 'minutes.rate_not_found',
  MINUTES_AMOUNT_TOO_LOW: 'minutes.amount_too_low',
  // Presence (calls revamp)
  PRESENCE_HEARTBEAT_OK: 'presence.heartbeat.ok',
  PRESENCE_FETCHED: 'presence.fetched',
  // Instant calls (calls revamp)
  INSTANT_CALL_STARTED: 'instant_call.started',
  INSTANT_CALL_ANSWERED: 'instant_call.answered',
  INSTANT_CALL_ENDED: 'instant_call.ended',
  INSTANT_CALL_PAUSED: 'instant_call.paused',
  INSTANT_CALL_RESUMED: 'instant_call.resumed',
  INSTANT_CALL_NOT_ACTIVE: 'instant_call.not_active',
  INSTANT_CALL_INCOMING_FETCHED: 'instant_call.incoming.fetched',
  INSTANT_CALL_NOT_FOUND: 'instant_call.not_found',
  INSTANT_CALL_NOT_RINGING: 'instant_call.not_ringing',
  INSTANT_CALL_NO_MINUTES: 'instant_call.no_minutes',
  INSTANT_CALL_OFFLINE: 'instant_call.offline',
  INSTANT_CALL_NOT_ACCEPTING: 'instant_call.not_accepting',
  INSTANT_CALL_DND: 'instant_call.dnd',
  INSTANT_CALL_BUSY: 'instant_call.busy',
  INSTANT_CALL_CANNOT_CALL_SELF: 'instant_call.cannot_call_self',
  // Multi-party invites (revamp-2 phase 8)
  CALL_INVITE_CREATED: 'call_invite.created',
  CALL_INVITE_APPROVED: 'call_invite.approved',
  CALL_INVITE_DECLINED: 'call_invite.declined',
  CALL_INVITE_ACCEPTED: 'call_invite.accepted',
  CALL_INVITE_NOT_FOUND: 'call_invite.not_found',
  CALL_INVITE_FORBIDDEN: 'call_invite.forbidden',
  CALL_INVITE_ROOM_FULL: 'call_invite.room_full',
  CALL_INVITE_INVALID_TARGET: 'call_invite.invalid_target',
  CALL_INVITE_ALREADY_RESOLVED: 'call_invite.already_resolved',
  CALL_PARTICIPANTS_LISTED: 'call_invite.participants_listed',
  FEATURE_DISABLED: 'general.feature_disabled',
  // Notifications + badges (revamp-2)
  NOTIFICATIONS_LISTED: 'notifications.listed',
  NOTIFICATIONS_MARKED_READ: 'notifications.marked_read',
  NOTIFICATIONS_NOT_FOUND: 'notifications.not_found',
  BADGES_FETCHED: 'badges.fetched',
  SURFACE_SEEN: 'badges.surface_seen',
  // Campaigns (revamp-2)
  CAMPAIGN_CREATED: 'campaign.created',
  CAMPAIGNS_LISTED: 'campaign.listed',
  CAMPAIGN_SCHEDULED: 'campaign.scheduled',
  CAMPAIGN_CANCELLED: 'campaign.cancelled',
  CAMPAIGN_NOT_FOUND: 'campaign.not_found',
  CAMPAIGN_NOT_ACTIONABLE: 'campaign.not_actionable',
  // App version gating (revamp-2)
  APP_VERSION_CHECKED: 'app_version.checked',
  APP_VERSION_LISTED: 'app_version.listed',
  APP_VERSION_SAVED: 'app_version.saved',
  // Purchase intents (revamp-2)
  INTENT_CREATED: 'intent.created',
  INTENT_FETCHED: 'intent.fetched',
  INTENT_VERIFIED: 'intent.verified',
  INTENT_CANCELLED: 'intent.cancelled',
  INTENT_NOT_FOUND: 'intent.not_found',
  INTENT_NOT_ACTIONABLE: 'intent.not_actionable',
  INTENT_PRO_NOT_FOUND: 'intent.professional_not_found',
  // Chat (calls revamp)
  CHAT_CONVERSATIONS_FETCHED: 'chat.conversations.fetched',
  CHAT_CONTEXT_FETCHED: 'chat.context.fetched',
  CHAT_CONVERSATION_OPENED: 'chat.conversation.opened',
  CHAT_MESSAGES_FETCHED: 'chat.messages.fetched',
  CHAT_MESSAGE_SENT: 'chat.message.sent',
  CHAT_MARKED_READ: 'chat.marked_read',
  CHAT_UNREAD_FETCHED: 'chat.unread.fetched',
  CHAT_NOT_FOUND: 'chat.not_found',
  CHAT_NEEDS_MINUTES: 'chat.needs_minutes',
  CHAT_PRO_NOT_FOUND: 'chat.professional_not_found',
  CHAT_CANNOT_CHAT_SELF: 'chat.cannot_chat_self',
  CHAT_SCHEDULE_PROPOSED: 'chat.schedule.proposed',
  CHAT_SCHEDULE_UPDATED: 'chat.schedule.updated',
  CHAT_SCHEDULE_NOT_FOUND: 'chat.schedule.not_found',
  CHAT_SCHEDULE_NOT_ACTIONABLE: 'chat.schedule.not_actionable',
  CHAT_SCHEDULE_INVALID_TIME: 'chat.schedule.invalid_time',
  CHAT_SCHEDULE_IN_PAST: 'chat.schedule.in_past',
  // Categories
